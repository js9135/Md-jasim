					...
					<div className="row">
						<div className="col-lg-12">
							<ul className="socila-list">
								<li><a href="https://twitter.com/WIZARD_BSC" target="_blank"><img src={socialcharacter1} /></a></li>
								<li><a href="https://t.me/wizard_financial" target="_blank"><img src={twitter2} /></a></li>
								<li><a href="https://medium.com/@wizardtokenofficial" target="_blank"><img src={telegram3} /></a></li>
								<li><a href="https://discord.com/invite/dfKrgACzHx" target="_blank"><img src={Subtraction4 } /></a></li>
